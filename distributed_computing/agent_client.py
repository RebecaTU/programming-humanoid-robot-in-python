...
class ClientAgent(object):
    ...
    def set_angle(self, joint_name, angle):
        ...
        '''
        # YOUR CODE HERE
        return self.RPCproxy.set_angle(self,joint_name, angle)
    ...
    def execute_keyframes(self, keyframes):
        ...
        '''
        # YOUR CODE HERE
        return self.RPCproxy.execute_keyframes(self, keyframes)
    ...
    def set_transform(self, effector_name, transform):
        ...
        '''
        # YOUR CODE HERE
        return self.RPCproxy.set_trasform(self, effector_name, transform)
